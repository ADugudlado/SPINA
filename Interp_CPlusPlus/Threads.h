...
// ver 6.0        similar to the .Net Thread class                     //
//                                                                     //
...
/////////////////////////////////////////////////////////////
// classes your derive from class Thread_Processing
// define code that the created thread executes

class Thread_Processing
{
public:
  virtual ~Thread_Processing() {}
  virtual Thread_Processing* clone() const = 0
  {
    // see test stub for example of how
    // applications will define this
  }
  virtual void run() = 0
  {
...
//
template <thread_type type>
Thread<type>::Thread(Thread_Processing& p) 
